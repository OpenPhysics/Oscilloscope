...
export const LIGHT_SURFACE_TEXT_FILL = OscilloscopeColors.controlSurfaceTextColorProperty;
...
export const SIM_COMBO_BOX_OPTIONS = {
  ...
  listStroke: OscilloscopeColors.panelBorderColorProperty,
...
export const TIME_CONTROL_SPEED_RADIO_OPTIONS = {
  speedRadioButtonGroupOptions: {
    labelOptions: { fill: OscilloscopeColors.textColorProperty },
  },
